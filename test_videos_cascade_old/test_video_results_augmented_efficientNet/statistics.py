...
def create_confusion_matrix_for_all_videos(video_numbers, class_labels):
    # Basispfad
    base_path = r"C:\Users\aaron\Desktop\Programmierung\Master\Machine Vision\Computer-Robot_Vision_repo\test_video_results_augmented_mobile60k\tests"
...
def display_confusion_matrices_for_all_videos(video_numbers, class_labels, total_confusion_matrix=None):
    # Basispfad
    base_path = r"C:\Users\aaron\Desktop\Programmierung\Master\Machine Vision\Computer-Robot_Vision_repo\test_video_results_augmented_mobile_less_classes\tests"
...
def main():
    video_name = 'GX010097'
    actual_file = fr"C:\Users\aaron\Desktop\Programmierung\Master\Machine Vision\Computer-Robot_Vision_repo\test_video_results_augmented_mobile_less_classes\tests\{video_name}\{video_name}_labels.xlsx"
    predicted_file = fr"C:\Users\aaron\Desktop\Programmierung\Master\Machine Vision\Computer-Robot_Vision_repo\test_video_results_augmented_mobile_less_classes\tests\{video_name}\predicted_labels_{video_name}.csv"
    less_confusion_matrix_path = fr"C:\Users\aaron\Desktop\Programmierung\Master\Machine Vision\Computer-Robot_Vision_repo\test_video_results_augmented_mobile_less_classes\tests\{video_name}\{video_name}_confusion_matrix.npy"
    ...
    #     actual_file = fr"C:\Users\aaron\Desktop\Programmierung\Master\Machine Vision\Computer-Robot_Vision_repo\test_video_results_augmented_mobile60k\tests\{video_id}\{video_id}_labels.xlsx"
    #     predicted_file = fr"C:\Users\aaron\Desktop\Programmierung\Master\Machine Vision\Computer-Robot_Vision_repo\test_video_results_augmented_mobile60k\tests\{video_id}\predicted_labels_{video_id}.csv"
    #     confusion_matrix_path = fr"C:\Users\aaron\Desktop\Programmierung\Master\Machine Vision\Computer-Robot_Vision_repo\test_video_results_augmented_mobile60k\tests\{video_id}\{video_id}_confusion_matrix.npy"
    ...
    video_id = "GX010108_d"
    plt.figure(figsize=(10, 8))
    less_matrix = np.load(f"C:/Users/aaron/Desktop/Programmierung/Master/Machine Vision/Computer-Robot_Vision_repo/test_video_results_augmented_mobile_less_classes/tests/{video_id}/{video_id}_confusion_matrix.npy")
    matrix_60k = np.load(f"C:/Users/aaron/Desktop/Programmierung/Master/Machine Vision/Computer-Robot_Vision_repo/test_video_results_augmented_mobile60k/tests/{video_id}/{video_id}_confusion_matrix.npy")
    display_matrix(less_matrix, class_labels_less_classes, f"{video_id} Less Classes", False, False)
    plt.figure(figsize=(10, 8))
    display_matrix(matrix_60k, class_labels_less_classes, f"{video_id} 60k", False, False)
    # Zeige alle Fenster an
    plt.show()


    #create_confusion_matrix_for_all_videos(video_numbers, class_labels)
    ...
    #display_confusion_matrices_for_all_videos(video_numbers, class_labels_less_classes, total_confusion_matrix)
